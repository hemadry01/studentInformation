package com.example.studentdetails.Features.SubjectCRUD.ShowSubjectList;
...
import com.example.studentdetails.Features.SubjectCRUD.UpdateSubjectInfo.SubjectUpdateListene;
...
public class SubjectListRecyclerViewAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    private void editSubject(long subjectId, int listPosition){
        SubjectUpdateDialogFragmen subjectUpdateDialogFragment = (SubjectUpdateDialogFragmen) SubjectUpdateDialogFragmen.newInstance(subjectId, listPosition, new SubjectUpdateListene()
        {
            @Override
