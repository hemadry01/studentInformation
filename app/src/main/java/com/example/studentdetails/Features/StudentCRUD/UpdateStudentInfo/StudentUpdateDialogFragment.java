package com.example.studentdetails.Features.StudentCRUD.UpdateStudentInfo;
...
public class StudentUpdateDialogFragment extends DialogFragment {
    ...
    private static StudentUpdateListene studentUpdateListener;
    ...
    public static StudentUpdateDialogFragment newInstance(long registrationNumber, int position, StudentUpdateListene listener){
